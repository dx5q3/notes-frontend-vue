...
<template>
    <main class="bg-white dark:bg-gray-900">
        <div class="container px-6 py-10 mx-auto">
            ...
            <div v-if="notes.length === 0" class="container flex flex-col px-6 py-10 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
                ...
                <div class="flex items-center justify-center w-full h-96 lg:w-1/2">
                    <img class="object-cover w-full h-full max-w-2xl rounded-md"
                        src="https://images.unsplash.com/photo-1555181126-cf46a03827c0"
                        alt="glasses photo">
                </div>
            </div>
            <div v-if="notes.length !== 0" class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 sm:grid-cols-2 lg:grid-cols-3">
